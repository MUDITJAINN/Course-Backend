...
import bcrypt from "bcryptjs"; // to secure password in hash format
...
export const signup = async (req, res) => {
  ...
  const userSchema = z.object({
    firstName: z
      .string()
      .min(3, { message: "firstName must be atleast 3 char long" }),  // validation checking that firstName is atleast 3 char long
    lastName: z
      .string()
